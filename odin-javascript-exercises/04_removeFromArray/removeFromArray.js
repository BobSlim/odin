const removeFromArray = function(originalArray = [], value1 = null, value2 = null, value3 = null, value4 = null) {
    ...
    for(let i=0;i < valuesToRemove.length;i++){
        finalArray = finalArray.filter(checkedValue => checkedValue !== valuesToRemove[i])
    };
    return finalArray;
};
